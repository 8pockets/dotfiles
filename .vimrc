...
"\ エスケープ記号
"$ ファイル名の最後
let g:NERDTreeIgnore=['\.clean$', '\.swp$', '\.swo$', '\.bak$', '\~$']
...
" Vim起動時（コンソール）にThe NERD Treeを開く
...
"
"
nnoremap <silent> sw :CtrlPYankRound<CR>
...
" か＝ソル行をハイライトすると、長いファイルを開くと重くなるので削除
"
" カーソル行をハイライト
"set cursorline
" カレントウィンドウにのみ罫線を引く
